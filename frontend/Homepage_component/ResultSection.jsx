  ...
  const handleInterest = async () => {
    try {
      ...
      const flatResponse = await axios.get(
        `https://flatbuddies.onrender.com/api/user/flat/${flat.id}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
      ...
      const response = await axios.post(
        "https://flatbuddies.onrender.com/api/user/send-to-owner",
        {
          interestedUser: {
...
const FlatmateCard = ({ flatmate, gradient, badge }) => {
  ...
  //       `https://flatbuddies.onrender.com/api/user/flatmate/${flatmate.id}`,
  //       {
  //         headers: { Authorization: `Bearer ${token}` },
  //       }
  //     );
  ...
  //     await axios.post(
  //       "https://flatbuddies.onrender.com/api/user/send-to-flatmate",
  //       {
  //         interestedUser: {
  //           username: currentUser.username,
  //           email: currentUser.email,
