...
// import UserResultsSection from "./userResultSection";
...
//     try {
//       const res = await axios.get("https://flatbuddies.onrender.com/api/user/userdata", {
...
//       await axios.put("https://flatbuddies.onrender.com/api/user/userdata/update", user, {
//         headers: {
...
//       fetchUserData(token);
//       fetchFlats(token);
//       fetchFlatmates(token);
//     }
//   }, []);

//   const fetchFlats = async (token) => {
//     try {
//       setLoading((prev) => ({ ...prev, flats: true }));
//       const response = await axios.get(
//         "https://flatbuddies.onrender.com/api/user/getFlats/user",
//         {
//           headers: { Authorization: `Bearer ${token}` },
//         }
//       );
...
//   const fetchFlatmates = async (token) => {
//     try {
//       setLoading((prev) => ({ ...prev, flatmates: true }));
//       const response = await axios.get(
//         "https://flatbuddies.onrender.com/api/user/getFlatmates/user",
//         {
//           headers: { Authorization: `Bearer ${token}` },
//         }
//       );
...
//       const endpoint =
//         type === "flat"
//           ? `https://flatbuddies.onrender.com/api/flats/${id}`
//           : `https://flatbuddies.onrender.com/api/flatmates/${id}`;
...
//       alert(
//         `${type === "flat" ? "Flat" : "Flatmate post"} deleted successfully`
//       );
//     } catch (error) {
...
//   <UserResultsSection
//     activeTab={activeTab}
//     results={activeTab === "flats" ? flats : flatmates}
...
//   //       "https://flatbuddies.onrender.com/api/user/registerflat",
//   //       propertyFormData,
//   //       {
//   //         headers: {
//   //           Authorization: `Bearer ${token}`,
...
//       const response = await axios.post(
//         "https://flatbuddies.onrender.com/api/user/registerflatMate",
//         flatMateFormData,
//         {
//           headers: {
//             Authorization: `Bearer ${token}`,
...
//       </div>
//       <div className="">
//         <h1 className="center">Your as FlatMate</h1>
//         <ResultsSection
//           activeTab="flatmates"
//           results={flatmates}
//           loading={loading.flatmates}
//         />
//       </div> */}
...
const ProfilePage = () => {
  ...
  const fetchUserData = async (token) => {
    try {
      const res = await axios.get(
        "https://flatbuddies.onrender.com/api/user/userdata",
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
  ...
  const handleProfileUpdate = async (e) => {
    ...
    try {
      const token = localStorage.getItem("token");
      await axios.put(
        "https://flatbuddies.onrender.com/api/user/userdata/update",
        user,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleDelete = async (id, type) => {
    try {
      ...
      const endpoint =
        type === "flat"
          ? `https://flatbuddies.onrender.com/api/user/getflats/${id}`
          : `https://flatbuddies.onrender.com/api/user/getFlatmates/${id}`;
